...
<html>
<head>
<title>Administrar autores. Insertar.</title>
...
<span id="btn" style="cursor:pointer;float:left;width:auto;clear:both;color:red;margin-top:20px;margin-left:20px;" onClick="insertarAutoresAdmin();">Guardar</span>
</div>
</body>
</html>