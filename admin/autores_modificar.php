...
<html>
<head>
<title>Administrar al autor <?php echo $datosautores; ?></title>
...
<div class="contenedor_reg" style="margin-left:20px;">
    ...
    <input type="text" id="nombre" value="<?php echo $datosautores; ?>" placeholder="Nombre" />
</div>



<span id="validacion" style="float:left;width:400px;clear:both;color:green;margin-top:20px;"></span>
<span id="btn" style="cursor:pointer; float:left; width:auto; clear:both; color:red; margin-top:20px;margin-left:20px;" onClick="enviarAutorAdmin();">Guardar</span>
</div>
</body>
</html>